    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            @DefaultRenderersFactory.ExtensionRendererMode int extensionRendererMode =
                    ((GlobalApplication) getApplication()).useExtensionRenderers()
 ...
 /*     case C.TYPE_DASH:
  ...
  /*    case C.TYPE_SS:
    ...
    private List<StreamKey> getOfflineStreamKeys(Uri uri) {
        return ((GlobalApplication) getApplication()).getDownloadTracker().getOfflineStreamKeys(uri);
    }
...
/*  private List<StreamKey> getOfflineStreamKeys(Uri uri) {
    ...
    private DefaultDrmSessionManager<FrameworkMediaCrypto> buildDrmSessionManagerV18(
        ...
        HttpDataSource.Factory licenseDataSourceFactory =
                ((GlobalApplication) getApplication()).buildHttpDataSourceFactory();
    ...
    private DataSource.Factory buildDataSourceFactory() {
        return ((GlobalApplication) getApplication()).buildDataSourceFactory();
    }
